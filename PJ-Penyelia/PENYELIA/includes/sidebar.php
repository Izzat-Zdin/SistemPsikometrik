    ...
    <div class="sidebar" id="sidebar">
        <nav class="sidebar__container">
            ...
            <div class="sidebar__account">
                <!-- Profile Picture -->
                <img src="<?php echo $penyelia_gambar ? 'profil/img-profil/'.$penyelia_gambar : 'https://www.pngkey.com/png/full/73-730477_first-name-profile-image-placeholder-png.png'; ?>"
