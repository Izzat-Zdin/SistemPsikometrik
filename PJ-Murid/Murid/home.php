...
<body>
    <!-- Sidebar bg   <div class="bg-image" style="background-color: #051622 
; width: 100%; height: 100%; position: absolute; top: 0; left: 0; z-index: -1;">
    ...
    <main class="main container" id="main">
        ...
        <div class="contact-section"
            style="background-color:#333333; position:absolute; top:12.8%; left:66%; height:78.5%; transform: scale(0.7);">
